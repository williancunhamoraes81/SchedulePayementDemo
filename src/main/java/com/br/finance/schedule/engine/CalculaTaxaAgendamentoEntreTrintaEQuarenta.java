...
public class CalculaTaxaAgendamentoEntreTrintaEQuarenta implements CalculaTaxa {

    private static final BigDecimal PORCENTAGEM_TAXA    = new BigDecimal("0.047");
    private static final Long VALOR_DIAS_DE             = 30L;
    private static final Long VALOR_DIAS_ATE            = 40L;
